...
class DataSet:
    ...
    def creator(cls, name, augment, augment_valid, parse_fn=default_parse, colors=3, nclass=2, height=IMAGE_SIZE, width=IMAGE_SIZE):
        ...
        def create():
            DATA_DIR = '/home/latte/project/retina_ckd/code/eGFR_age_sex_with_proteinuria_EfficientNet_SmoothGrad/data_w_id_bright_haze995_standardization/devset/tfrecords/'
